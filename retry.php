        	...
        	<section id="home-content">
				...
				<div id="home-header"> 
                	...
                	<form action="setSession.php" method="post" class="login-form">
                            <input type="text" placeholder="Username" class="login-uname login-error" name="username"> 
                            <input type="password" placeholder="Password" class="login-pword login-error" name="password">
                            <span class="error"> Information not found on database. Please try again. </span>
